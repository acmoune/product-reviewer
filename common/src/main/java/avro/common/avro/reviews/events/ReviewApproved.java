...
public class ReviewApproved extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<ReviewApproved> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ReviewApproved> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ReviewApproved>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ReviewApproved to a ByteBuffer.
  ...
  /**
   * Deserializes a ReviewApproved from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ReviewApproved instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ReviewApproved fromByteBuffer(
   ...
   */
  public ReviewApproved(java.lang.String task_id, common.avro.reviews.entities.Review review) {
  ...
  /**
   * Creates a new ReviewApproved RecordBuilder.
   * @return A new ReviewApproved RecordBuilder
   */
  public static common.avro.reviews.events.ReviewApproved.Builder newBuilder() {
    return new common.avro.reviews.events.ReviewApproved.Builder();
  }

  /**
   * Creates a new ReviewApproved RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ReviewApproved RecordBuilder
   */
  public static common.avro.reviews.events.ReviewApproved.Builder newBuilder(common.avro.reviews.events.ReviewApproved.Builder other) {
    if (other == null) {
      return new common.avro.reviews.events.ReviewApproved.Builder();
    } else {
      return new common.avro.reviews.events.ReviewApproved.Builder(other);
    }
  }

  /**
   * Creates a new ReviewApproved RecordBuilder by copying an existing ReviewApproved instance.
   * @param other The existing instance to copy.
   * @return A new ReviewApproved RecordBuilder
   */
  public static common.avro.reviews.events.ReviewApproved.Builder newBuilder(common.avro.reviews.events.ReviewApproved other) {
    if (other == null) {
      return new common.avro.reviews.events.ReviewApproved.Builder();
    } else {
      return new common.avro.reviews.events.ReviewApproved.Builder(other);
  ...
  /**
   * RecordBuilder for ReviewApproved instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReviewApproved>
    implements org.apache.avro.data.RecordBuilder<ReviewApproved> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(common.avro.reviews.events.ReviewApproved.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ReviewApproved instance
     * @param other The existing instance to copy.
     */
    private Builder(common.avro.reviews.events.ReviewApproved other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.task_id)) {
        this.task_id = data().deepCopy(fields()[0].schema(), other.task_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public common.avro.reviews.events.ReviewApproved.Builder setTaskId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public common.avro.reviews.events.ReviewApproved.Builder clearTaskId() {
      task_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public common.avro.reviews.events.ReviewApproved.Builder setReview(common.avro.reviews.entities.Review value) {
     ...
     * @return This builder.
     */
    public common.avro.reviews.events.ReviewApproved.Builder setReviewBuilder(common.avro.reviews.entities.Review.Builder value) {
      clearReview();
      reviewBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public common.avro.reviews.events.ReviewApproved.Builder clearReview() {
      review = null;
      reviewBuilder = null;
    ...
    public ReviewApproved build() {
      try {
        ReviewApproved record = new ReviewApproved();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ReviewApproved>
    WRITER$ = (org.apache.avro.io.DatumWriter<ReviewApproved>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ReviewApproved>
    READER$ = (org.apache.avro.io.DatumReader<ReviewApproved>)MODEL$.createDatumReader(SCHEMA$);
